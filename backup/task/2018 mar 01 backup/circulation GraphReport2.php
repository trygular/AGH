...
?>		 
		...
		<?
			...
			while($rowqry=fetch($resqry))
			{
				echo"<tr> <th colspan=7 style='text-align:left;background-color:#f1b25b;cursor:pointer;margin-right:250px'>$rowqry[1]</th> </tr>";
				...
				while($rowquest=fetch($resqryques))
				{
					if($rowqry[0]!=9 && $rowqry[0]!=10)
					{
						...
						echo "<table border='1' id='displaytbl".$tabindex."one' class='silent'  style='background-color:#dadada;border-color: #000000;width: 100%;'>";
						...
						echo "<table border='1' id='displaytbl".$tabindex."two' class='silent'  style='background-color:#dadada;border-color: #000000;width: 100%;'>";
						echo "<tr><th style='width:10%;'>ID</th><th style='width:30%'>Name</th><th style='width:30%'>Region</th><th style='width:30%'>Branch</th></tr>";
						...
						echo "<table border='1' id='displaytbl".$tabindex."thr' class='silent'  style='background-color:#dadada;border-color: #000000;width: 100%;'>";
						echo "<tr><th style='width:10%;'>ID</th><th style='width:30%'>Name</th><th style='width:30%'>Region</th><th style='width:30%'>Branch</th></tr>";
