...
if($_POST['company']!="all")
 ...
 //  echo  "<center> <p class='btn btn-info' style='font-color:white;font-weight:bold;font-size:16px;'>Region : ".$branch." &nbsp;&nbsp;&nbsp; Department :  ".$department." &nbsp;&nbsp;&nbsp; Company : ".$company." </p></center><br>";
   ...
   $pdf->SetFont('Arial','',8); 
	...
	echo "Absent Memo  between ".$_POST['frmdate']." to ".$_POST['todate']."</td></tr>";
    	   ...
    	   while($StaffMasterRow = fetch($StaffMasterRes))
    	   {
				...
				while($rowabsent = fetch($resabsent))					
				{
				 ...
				 if($days>=1)
				 {
						...
						echo" <tr>
						<td colspan=6 >Emp Code / Name :-  ".$StaffMasterRow[0]." / ".$StaffMasterRow[1]."  <td><td colspan=6> Dept :- ".$rowdept1[1]." </td><td colspan=6> Branch :-   ".$rowbranch[1]."  </td><td colspan=6> Region :- ".$rowregion[1]."</td><td><input type='button' class='btn btn-primary' value='Mark as Leave' onclick='makeasleave(".$StaffMasterRow[0].");'></td><td><input type='button' class='btn btn-info' value='Correction' onclick='correction(".$StaffMasterRow[0].");'></td>
						</tr> ";
