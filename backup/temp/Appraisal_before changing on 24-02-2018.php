...
{
	var empcode = $('#ecode').val();
	var empcaza = $('#ecaza').val();
	
	if($.trim(empcode)== "" || $.trim(empcaza)== "" ) { 
		//alert("Employment Id Is missing..!!");
		return false;
	}
	...
	$.ajax({
		url:"Appraisal.php",
		data:"action=CrewRatings&empcode="+empcode+"&crew_ratings="+crew_ratings+"&empcaza="+empcaza,
		type:"post",				  
		success:function(output)
		{
			output1 = $.trim(output);
...
<a href='Appraisal.php'><input class='btn btn-primary' type='button'  value='Back' style='font-color:white;font-weight:bold;font-size:16px;float:left'/></a>
															...
															<div class="col-md-4">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		...
																		<input type="hidden" id='ecaza' name='ecaza' value="<? echo $ecodearr[0]; ?>" readonly />
																	</div>
																</div>
