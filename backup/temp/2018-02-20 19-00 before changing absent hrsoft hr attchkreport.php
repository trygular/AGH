...
//------------------------- absent
	...
	/*
	echo "<center><table style='width:80%;' class='table table-bordered'>";

	echo "<tr>";
	echo "<td colspan='3'>Absent Memo between ".$_POST['frmdate']." to ".$_POST['todate']." </td>";
	echo "</tr>";
	
	echo "<tr>";
	echo "<td>Emp Code / Name :- </td>";
	echo "<td></td>";
	echo "<td></td>";
	echo "</tr>";
	...
	echo "<tr>";
	echo "<td colspan='3'>You have been marked absent on the following dates. Please fill up OD/LEAVES at earliest.</td>";
	echo "</tr>";
