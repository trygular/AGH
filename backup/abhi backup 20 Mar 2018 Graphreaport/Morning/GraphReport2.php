...
<?
  ...
  {
?>	  
<input class='btn btn-danger' type='button' id='back' name='back' value='Back' style='float:right;margin-right:20px' onclick="window.location='GraphReport2.php'">
		 ...
		 while($rowquest = fetch($resquest))
		 {
			...
			while($rowqry=fetch($resqry))
			{
				if($rowqry[1]==0&&$rowqry[2]==0&&$rowqry[3]==0)	
				{
					...
					window.location="GraphReport2.php";
					</script>
					<?
				}	
			}
