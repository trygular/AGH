...
?>
	...
	<!-- Back button -->
	<button class='btn' id='back' name='back' style='float:right;' onclick="window.location='GraphReport3.1.php'">BACK</button>
...
<?
	...
	while($rowqry = fetch($resqry))
	{
		...
		*/
		...
		{
			if($rowqry[0]!=9 && $rowqry[0]!=10) // && $_POST['empcode'] == "")
			{
...
<form method="POST" Action="GraphReport3.1.php" name="form">
	<center>
	<br>
