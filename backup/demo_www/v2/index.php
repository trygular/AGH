...
{  
 ...
 document.getElementById("row"+no+"").outerHTML="";
	...
	$("#form_add").click(function(){
		...
		if($("#sname").val()=='') { $("#sname").val("").focus(); return;
		}else if($("#mid").val()==''){ $("#mid").val("").focus(); return;
		}else if($("#sid").val()==''){ $("#sid").val("").focus(); return;
		}else if($("#m1").val()==''){ $("#m1").val("").focus(); return;
		}else if($("#m2").val()==''){ $("#m2").val("").focus(); return;
		}else if($("#m3").val()==''){ $("#m3").val("").focus(); return;
		}
